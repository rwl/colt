...
doubleMatrix1DTests() {
  ...
  testDoubleMatrix1D('DenseDoubleMatrix1D', new DenseDoubleMatrix1DViewTest());

  testDoubleMatrix1D('SparseDoubleMatrix1D', new SparseDoubleMatrix1DTest());
  testDoubleMatrix1D('SparseDoubleMatrix1D', new SparseDoubleMatrix1DViewTest());
}

doubleMatrix2DTests() {
  testDenseDoubleMatrix2D('DenseDoubleMatrix2D', new DenseDoubleMatrix2DTest());
  testDenseDoubleMatrix2D('DenseDoubleMatrix2D', new DenseDoubleMatrix2DViewTest());
  testDoubleMatrix2D('DiagonalDoubleMatrix2D', new DiagonalDoubleMatrix2DTest());
  testDoubleMatrix2D('DiagonalDoubleMatrix2D', new DiagonalDoubleMatrix2DViewTest());

  testDoubleMatrix2D('SparseCCDoubleMatrix2D', new SparseCCDoubleMatrix2DTest());
  testDoubleMatrix2D('SparseCCDoubleMatrix2D', new SparseCCDoubleMatrix2DViewTest());
  testDoubleMatrix2D('SparseDoubleMatrix2D', new SparseDoubleMatrix2DTest());
  testDoubleMatrix2D('SparseDoubleMatrix2D', new SparseDoubleMatrix2DViewTest());
  testDoubleMatrix2D('SparseRCDoubleMatrix2D', new SparseRCDoubleMatrix2DTest());
  testDoubleMatrix2D('SparseRCDoubleMatrix2D', new SparseRCDoubleMatrix2DViewTest());
}

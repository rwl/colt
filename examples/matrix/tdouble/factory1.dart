...
void main() {
//  stdout.writeln("\n\n");
//  List<List<AbstractDoubleMatrix>> parts1 = [[null, make(2, 2, 1), null], [make(4, 4, 2), null, make(4, 3, 3)],
...
//   */
//
//  List<List<AbstractDoubleMatrix>> parts3 = [[identity(3), null,], [null, identity(3).columnFlip()],
//                                       [identity(3).rowFlip(), null]];
//  stdout.writeln("\n" + DoubleFactory2D.compose(parts3));
//  // stdout.writeln("\n"+matrixpattern.Converting.toHTML(make(parts3).toString()));
//
//  AbstractDoubleMatrix A = DoubleFactory2D.dense.ascending(2, 2);
//  AbstractDoubleMatrix B = DoubleFactory2D.dense.descending(2, 2);
//  AbstractDoubleMatrix _ = null;
//
//  List<List<AbstractDoubleMatrix>> parts4 = [[A, _, A, _], [_, A, _, B]];

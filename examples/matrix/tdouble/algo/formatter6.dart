...
//    List<String> columnNames = [ "W", "X", "Y", "Z" ];
...
//    stdout.writeln(new DoubleFormatter().toString(DoubleFactory2D.dense.make(values)));
//    stdout.writeln(new DoubleFormatter()._toTitleString(DoubleFactory2D.dense

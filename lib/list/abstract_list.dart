...
abstract class AbstractList extends AbstractCollection {
     ...
     */
    void addAllOf(Collection collection) {
     ...
     */
    void beforeInsertAllOf(int index, Collection collection) {
        this._beforeInsertDummies(index, collection.size());
     ...
     */
    static void _checkRange(int index, int theSize) {
        if (index >= theSize || index < 0)
            throw new RangeError("Index: " + index + ", Size: " + theSize);
    }
     ...
     *             .
     */
    static void _checkRangeFromTo(int from, int to, int theSize) {
        if (to == from - 1)
            return;
    ...
    void setSize(int newSize) {
        ...
        if (newSize != currentSize) {
            if (newSize > currentSize)
                _beforeInsertDummies(currentSize, newSize - currentSize);

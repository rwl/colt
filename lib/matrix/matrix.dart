...
part 'double/dense_double_vector.dart';
part 'double/dense_double_matrix.dart';
part 'double/dense_large_double_matrix.dart';
...
part 'complex/dense_complex_vector.dart';
part 'complex/dense_complex_matrix.dart';
...
part 'int/dense_int_vector.dart';
part 'int/dense_int_matrix.dart';

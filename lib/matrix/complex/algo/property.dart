 ...
 *         otherwise.
 */
bool equalsVector(final AbstractComplexVector A, final AbstractComplexVector B, [double epsilon = EPSILON]) {
  if (identical(A, B)) {
    return true;
  }
  if (!(A != null && B != null)) {
 ...
 *         otherwise.
 */
bool equalsMatrix(final AbstractComplexMatrix A, final AbstractComplexMatrix B, [double epsilon = EPSILON]) {
  if (identical(A, B)) {
    return true;
  }
  if (!(A != null && B != null)) {

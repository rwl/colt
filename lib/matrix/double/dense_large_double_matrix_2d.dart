 ...
 * 
 */
class DenseLargeDoubleMatrix2D extends WrapperDoubleMatrix2D {

  List<Float64List> _elements;

  DenseLargeDoubleMatrix2D(int rows, int columns, [List<Float64List> elements=null]) : super(null) {
    try {
      _setUp(rows, columns);
  ...
  Object clone() {
    return new DenseLargeDoubleMatrix2D(_rows, _columns, _elements);
  }
}

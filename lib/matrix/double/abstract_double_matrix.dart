 ...
 */
typedef bool DoubleVectorProcedure(AbstractDoubleVector element);
...
abstract class AbstractDoubleMatrix extends AbstractMatrix {
   ...
   * @see cern.jet.math.tdouble.DoubleFunctions
   */
  double reduceMatrix(final AbstractDoubleMatrix other, final DoubleDoubleFunction aggr, final DoubleDoubleFunction f) {
    checkShape(other);
    if (length == 0) return double.NAN;
    double a = 0.0;
    /*int nthreads = ConcurrencyUtils.getNumberOfThreads();
...
//    }
   ...
   */
  AbstractDoubleMatrix _view() {
    return clone() as AbstractDoubleMatrix;
  }

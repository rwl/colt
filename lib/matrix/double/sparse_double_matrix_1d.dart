 ...
 */
class SparseDoubleMatrix1D extends DoubleMatrix1D {
  ...
  /*SparseDoubleMatrix1D(int size/*, int initialCapacity, double minLoadFactor, double maxLoadFactor*/) {
    ...
    this._elements = new Map<int, double>();
  }*/
   ...
   *             if <tt>size<0</tt>.
   */
  SparseDoubleMatrix1D(int size, [Map<int, double> elements = null, int offset = 0, int stride = 1, bool isView = false]) {
    if (elements == null) {
  ...
  Object clone() {
    return new SparseDoubleMatrix1D(_size, _elements, _zero, _stride, !_isNoView);
  }
}
